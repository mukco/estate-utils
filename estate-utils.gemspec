...
Gem::Specification.new do |spec|
  ...
  spec.description   = "Cache::Answers resolves an expensive answer — a model completion, " \
                       ...
                       "never a wait on the request path. Cache::Warehouse is the " \
                       "build-stamped variant; Cache::AnswerLog says what the cache did."
